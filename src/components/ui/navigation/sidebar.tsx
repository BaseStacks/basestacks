...
function SidebarProvider({
  ...
  children,
  ...props
}: React.ComponentProps<"div"> & Readonly<{
  ...
  const setOpen = React.useCallback(
    (nextValue: boolean | ((_nextValue: boolean) => boolean)) => {
      const openState =
...
function SidebarGroupLabel({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<"div"> & Readonly<{ readonly asChild?: boolean }>) {
...
function SidebarGroupAction({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<"button"> & Readonly<{ readonly asChild?: boolean }>) {
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => {
    ...
    const percent = Math.floor(random * 40) + 50;
    return `${percent}%`;
  }, []);
...
function SidebarMenuSubButton({
  ...
  className,
  ...props
}: React.ComponentProps<"a"> & Readonly<{
  readonly asChild?: boolean;
  readonly size?: "sm" | "md";
  readonly isActive?: boolean;
}>) {
